...
<body>
        ...
        <div class="container-fluid main-content-area">
            <div class="row h-100">
                ...
                <aside class="col-lg-3 d-none d-lg-block sticky-sidebar right-sidebar">
                    ...
                    <footer class="footer-links mt-auto pt-3 border-top"><p class="text-muted" style="font-size: 0.8rem;">&copy; {{ date('Y') }} REMBUG</p></footer>
                    @endauth
                </aside>
            </div>
        </div>
    ...
    <script>
        function closeOffcanvasAndRedirect(url) {
            ...
            if (offcanvas) {
                offcanvas.hide();
                // Redirect after offcanvas is hidden
                setTimeout(() => {
                    window.location.href = url;
                }, 300);
            } else {
                // Fallback if offcanvas instance not found
                window.location.href = url;
            }
        }
    </script>
